...
function AwardSingle({ educationObj }) {
    ...
    <div className="py-4 px-2 bg-gray-50 border-2 border-gray-200 rounded-2xl">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-[1rem]">
          ...
          <p className="px-3 py-1 text-yellow-500 font-semibold rounded-2xl bg-yellow-100">
            {startYear}-{endYear}
          </p>
        </div>
        <div
      ...
      <p className="text-[1.2rem] font-semibold text-yellow-500 mb-1.5">
        {subTitle}
      </p>
      <p>{description}</p>
    </div>
